...
export const Source: React.FC<ISource> = ({url}) => {
  return (
    <div className="pt-10 mr-auto">
      <p className="text-gray-500 font-medium text-lg sm:inline-flex">Source: 
        <a href={url} target="_blank" className="flex flex-row break-all items-center gap-2 text-sm sm:text-base sm:ml-6 underline text-black">{url}
          <span>
