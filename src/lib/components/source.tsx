...
export const Source: React.FC<ISource> = ({url}) => {
  return (
    <div className="pt-10 mr-auto">
      <p className="font-medium text-lg sm:inline-flex text-[var(--text)]">Source: 
        <a href={url} target="_blank" className="flex flex-row break-all items-center gap-2 text-sm sm:text-base sm:ml-6 underline text-[var(--text)]">{url}
          <span>
